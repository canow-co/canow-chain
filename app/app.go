...
func New(
	...
	*/
	...
	anteHandler, err := cheqdapp.NewAnteHandler(cheqdapp.HandlerOptions{
	...
	app.UpgradeKeeper.SetUpgradeHandler("v0.3.0", func(ctx sdk.Context, plan upgradetypes.Plan, fromVM module.VersionMap) (module.VersionMap, error) {
