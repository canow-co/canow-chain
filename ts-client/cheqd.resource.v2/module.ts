...
import { MsgCreateResource } from "./types/cheqd/resource/v2/tx";


export { MsgCreateResource };
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		msgCreateResource({ value }: msgCreateResourceParams): EncodeObject {
			try {
				return { typeUrl: "/cheqd.resource.v2.MsgCreateResource", value: MsgCreateResource.fromPartial( value ) }  
			} catch (e: any) {
...
const Module = (test: IgniteClient) => {
	return {
		module: {
			CheqdResourceV2: new SDKModule(test)
		},
		registry: msgTypes
  }
}
